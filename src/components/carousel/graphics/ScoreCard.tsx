...
export function ScoreCard({ score = 'A+', label = 'SLEEP QUALITY RATING', sublabel, brandStyle }: Props) {
  ...
  return (
    <svg width={936} height={360} viewBox="0 0 936 360" overflow="visible">
      ...
      <line x1={696} y1={24} x2={636} y2={24} stroke={accent} strokeWidth={3} />
      <line x1={696} y1={24} x2={696} y2={64} stroke={accent} strokeWidth={3} />
      <line x1={240} y1={276} x2={300} y2={276} stroke={accent} strokeWidth={3} />
      <line x1={240} y1={276} x2={240} y2={236} stroke={accent} strokeWidth={3} />
      <line x1={696} y1={276} x2={636} y2={276} stroke={accent} strokeWidth={3} />
      <line x1={696} y1={276} x2={696} y2={236} stroke={accent} strokeWidth={3} />
      {/* Inner fill */}
      <rect x={250} y={30} width={436} height={250} rx={4} fill={`${accent}08`} />
      {/* Score */}
      ...
      {/* Divider */}
      <line x1={320} y1={295} x2={616} y2={295} stroke={`${bodyColor}25`} strokeWidth={1} />
      {/* Label */}
      <text x={468} y={323} textAnchor="middle"
        fontFamily="Outfit, sans-serif" fontSize="26" fontWeight="700"
        letterSpacing="0.12em" fill={bodyColor}>
        {label}
      </text>
      {sublabel && (
        <text x={468} y={350} textAnchor="middle"
