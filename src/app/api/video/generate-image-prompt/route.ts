...
export async function POST(req: Request) {
  ...
  try {
    ...
    const msg = await anthropic.messages.create({
      ...
      max_tokens: 200,
      system: `You write Recraft V3 (realistic_image) image generation prompts for Lunia Life video ads.
