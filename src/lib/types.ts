...
export type CampaignBlock = {
   ...
   *  original look); "normal" = Inter 400; "extralight" = Inter 200. Unset is
   *  treated as "light" so campaigns saved before this control render identically. */
  weight?: "extralight" | "light" | "normal";
};
