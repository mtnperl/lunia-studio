...
${isEditorial ? `- hookImageSpec (Editorial Scientific only — MANDATORY):
  ...
  Fields:
    ...
    • sceneElements: 3–6 specific physical items. The HOOK image is ALWAYS product-free editorial photography — NEVER include the Lunia bottle, Lunia Restore, any supplement bottle, capsule, pill, tincture, dropper, amber glass, packaging, jar. NEVER include the Lunia logo, wordmark, brand mark, monogram, or constellation symbol. The bottle and the brand mark belong on content slides, not on the hook. Use concrete editorial nouns: linen pillow, ceramic mug, dried flower, marble surface, single sage sprig, hands, half-face portrait, ceramic bowl, sheer curtain, warm wooden tray, herbal tea, fresh chamomile heads, raw silk, etc.
