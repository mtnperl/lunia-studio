...
function getSceneStyle(videoStyle = "cinematic") {
  switch (videoStyle) {
    case "serene":
      return {
        bg: "#1a3a4a",
...
;// ./src/remotion/lib/SceneImageBackground.tsx

"use client";



function SceneImageBackground({
  image,
  overlayOpacity = 0.35
}) {
  const frame = (0,esm.useCurrentFrame)();
  const opacity = (0,esm.interpolate)(frame, [0, 12], [0, 1], { extrapolateRight: "clamp" });
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Img,
          {
            ...
            style: {
              ...
              maxWidth: image.fit === "contain" ? "100%" : void 0,
              maxHeight: image.fit === "contain" ? "100%" : void 0,
              objectFit: image.fit,
              objectPosition: image.fit === "cover" ? image.position ?? "50% 50%" : void 0
            }
          }
        )
      }
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          height: 3,
          background: S.accentColor,
          opacity: (0,esm.interpolate)(frame, [20, 30], [0, 0.8], { extrapolateRight: "clamp" })
        }
      }
    )
  ] });
...
;// ./src/remotion/scenes/ScienceScene.tsx
...
function ScienceScene({
  ...
  const contentY = (0,esm.interpolate)(
    (0,esm.spring)({ frame: Math.max(0, frame - 15), fps, config: { damping: 18, stiffness: 100 } }),
    [0, 1],
    [30, 0]
  );
  const contentOpacity = (0,esm.interpolate)(frame, [15, 28], [0, 1], { extrapolateRight: "clamp" });
    ...
    esm.AbsoluteFill,
    {
      ...
      children: [
        ...
        scene.stat && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ...
          {
            style: {
              transform: `scale(${(0,esm.interpolate)(statScale, [0, 1], [0.6, 1])})`,
              opacity: statOpacity,
              marginBottom: 24
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              width: 4,
              background: S.accentColor,
              opacity: (0,esm.interpolate)(frame, [5, 20], [0, 0.7], { extrapolateRight: "clamp" })
            }
          }
        )
      ]
...
;// ./src/remotion/scenes/ProductScene.tsx
...
;// ./src/remotion/scenes/ProofScene.tsx
...
function ProofScene({
  ...
  const textY = (0,esm.interpolate)(
    (0,esm.spring)({ frame: Math.max(0, frame - 20), fps, config: { damping: 18, stiffness: 100 } }),
    [0, 1],
    [30, 0]
  );
  const textOpacity = (0,esm.interpolate)(frame, [20, 35], [0, 1], { extrapolateRight: "clamp" });
  const starOpacity = (0,esm.interpolate)(frame, [30, 45], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        ...
        scene.stat && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              opacity: statOpacity,
              transform: `translateX(${(0,esm.interpolate)(statProgress, [0, 1], [-30, 0])}px)`,
              marginBottom: 8
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
        ...
        scene.caption && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: statOpacity, marginBottom: 48 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              fontFamily: BRAND.fontFamily,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  width: 28,
...
function CTAScene({
  ...
  const headlineY = (0,esm.interpolate)(
    (0,esm.spring)({ frame: Math.max(0, frame - 8), fps, config: { damping: 16, stiffness: 100 } }),
    [0, 1],
    [50, 0]
  );
  const headlineOpacity = (0,esm.interpolate)(frame, [8, 22], [0, 1], { extrapolateRight: "clamp" });
  const sublineOpacity = (0,esm.interpolate)(frame, [25, 40], [0, 1], { extrapolateRight: "clamp" });
  const buttonScale = (0,esm.spring)({ frame: Math.max(0, frame - 40), fps, config: { damping: 14, stiffness: 120 } });
      ...
      esm.AbsoluteFill,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            ...
            {
              style: {
                transform: `scale(${(0,esm.interpolate)(buttonScale, [0, 1], [0.8, 1])})`,
...
function VideoAd(props) {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Series, { children: ORDER.map((type, idx) => {
    const scene = scenes.find((s) => s.type === type) ?? scenes[idx];
    if (!scene) return null;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Series.Sequence, { durationInFrames: scene.durationFrames, children: renderScene(type, idx) }, type);
  }) }) });
}

;// ./src/remotion/VideoAdCaptions.tsx
...
function VideoAdCaptions(props) {
  ...
  const blockIn = (0,esm.interpolate)(
    (0,esm.spring)({ frame: blockFrame, fps, config: { damping: 20, stiffness: 120 } }),
    [0, 1],
    [40, 0]
  );
  const blockOpacity = (0,esm.interpolate)(blockFrame, [0, 8], [0, 1], { extrapolateRight: "clamp" });
  const blockOut = (0,esm.interpolate)(blockFrame, [FRAMES_PER_BLOCK - 12, FRAMES_PER_BLOCK], [1, 0], { extrapolateLeft: "clamp" });
  const logoOpacity = (0,esm.interpolate)(frame, [fps * 0.5, fps], [0, 1], { extrapolateRight: "clamp" });
  const caption = captions[Math.min(currentBlock, captions.length - 1)] ?? "";
  const words = caption.split(" ");
  const bgImage = backgroundImageUrl ? { url: backgroundImageUrl, fit: "cover", position: "50% 50%" } : void 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { background: S.bg }, children: [
    bgImage && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneImageBackground, { image: bgImage, overlayOpacity: S.overlayOpacity + 0.1 }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: words.map((word, wIdx) => {
                  ...
                  const wOpacity = (0,esm.interpolate)(blockFrame, [wordStartFrame, wordStartFrame + 4], [0, 1], { extrapolateRight: "clamp" });
                  const wY = (0,esm.interpolate)(
                    (0,esm.spring)({ frame: Math.max(0, blockFrame - wordStartFrame), fps, config: { damping: 20, stiffness: 160 } }),
                    [0, 1],
                    [16, 0]
                  );
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: captions.map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
...
const DEFAULT_CAPTIONS_PROPS = {
  topic: "Better sleep with magnesium",
  fps: 30,
  durationFrames: 375,
  // 5 captions * 75 frames
  captions: [
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "lunia-studio:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklunia_studio"] = self["webpackChunklunia_studio"] || [];
